  ...
  return (
    <div id="experiences" className="experiences section">
      ...
      <div className="row d-flex">
        <h3 className="title col-lg-3 my-3">Education</h3>
        <ul className="content col-lg-9 my-3">
          <li className="row">
            <p className="col-lg-3 mb-3 p-2 text-end fw-700">
              私立長庚大學
            </p>
            <p className="col-lg-9 mb-3 p-2">
      ...
      <div className="row d-flex">
        <h3 className="title col-lg-3 my-3">Careers</h3>
        <ul className="content col-lg-9 my-3">
          <li className="row">
            <p className="col-lg-3 mb-3 p-2 text-end fw-700">
              三竹資訊股份有限公司 <br/>Mitake
            </p>
            <div className="col-lg-9 mb-3 p-2">
